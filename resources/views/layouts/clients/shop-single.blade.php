        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0">
                    ...
                    <strong class="text-black"> Chi tiết thú cưng</strong>
                    <span class="mx-2 mb-0">/</span>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p>Tổng: <strong>{{ $list->so_luong }}</strong></p>
                    ...
                    <div class="mb-5">
                        <div class="input-group mb-3" style="max-width: 120px;">
                            ...
                            <input type="number" id="so_luong" class="form-control text-center" value="1"
                    ...
                    <a href="#" id="add-to-cart" class="buy-now btn btn-sm btn-primary">Thêm vào giỏ hàng</a>
                </div>
            </div>
