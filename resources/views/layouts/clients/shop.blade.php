...
@section('content')
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="{{route('/.index')}}">Trang chủ</a> <span class="mx-2 mb-0">/</span> <strong
                            ...
                            <div class="d-flex">
                                <div class="dropdown mr-1 ml-md-auto">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                                        <a class="dropdown-item" href="#">{{$item->ten_danh_muc}}</a>
                                        <a class="dropdown-item" href="#">{{$item->ten_danh_muc}}</a>
                ...
                <div class="col-md-3 order-1 mb-5 mb-md-0">
                    ...
                    <div class="border p-4 rounded mb-4">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="mb-1"><a href="#" class="d-flex"><span>{{$item->ten_danh_muc}}</span> <span
