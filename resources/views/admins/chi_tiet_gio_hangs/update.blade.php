...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('chi-tiet-gio-hang.update', $gioHangCT->id) }}" method="POST" class="m-3">
                @method('put')
                @csrf
                ...
                <a href="{{ route('chi-tiet-gio-hang.index') }}"><button type="button" class="btn btn-info">Danh sách</button></a>
            </form>
        </div>
    </div>
@endsection
