...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        ...
        <a href="{{ route('chi-tiet-gio-hang.create') }}" class="btn btn-primary btn-icon-split">
                        ...
                        <tbody>
                            @foreach ($gioHangCT as $index => $gioHang)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('chi-tiet-gio-hang.edit', $gioHang->id) }}"
                                        ...
                                        <form action="{{ route('chi-tiet-gio-hang.destroy', $gioHang->id) }}" method="POST"
