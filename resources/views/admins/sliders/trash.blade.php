...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td class="align-items-center pt-5">
                                    <div class="d-flex justify-content-center">
                                        <form action="{{ route('admin.sliders.restore', $slider->id) }}" method="POST" style="display: inline;">
                                            @csrf
            ...
            <a href="{{ route('admin.slider.index') }}"><button type="button" class="btn btn-info">Danh sách</button></a>
        </div>
    </div>
