...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
       ...
       <div class="div">
        <a href="{{ route('admin.slider.create') }}" class="btn btn-primary btn-icon-split">
            <span class="icon text-white-50">
                <i class="fas fa-arrow-right"></i>
            </span>
            <span class="text">Thêm mới</span>
        </a>
        <a href="{{ url('admins/sliders/trash')}}" class="btn btn-secondary btn-icon-split">
            <span class="icon text-white-50">
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Alt</th>
                                <th class="text-center">Ảnh slider</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tfoot>
                            ...
                            @foreach ($sliders as $index => $slider)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img src="{{ Storage::url($slider->hinh_anh) }}" width="150" height="130"
                                            alt="{{ $slider->alt }}">
                                    </td>
                                    <td class="align-items-center pt-5">
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="mr-2">
                                                <form action="{{ route('admin.sliders.delete') }}" method="POST" style="display: inline;">
                                                    @csrf
