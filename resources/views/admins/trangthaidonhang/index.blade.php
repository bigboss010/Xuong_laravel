...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        ...
        <a href="{{ route('trang_thai_don_hangs.create') }}" class="btn btn-primary btn-icon-split">
                        ...
                        <tbody>
                            @foreach ($list as $index => $value)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('trang_thai_don_hangs.edit', $value->id) }}" class="btn btn-warning btn-icon-split">
                                            <span class="icon text-white-50">
