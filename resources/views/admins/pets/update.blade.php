    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form action="{{ route('admin.pet.update', $pet->id) }}" method="POST" enctype="multipart/form-data" class="m-3">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="mb-3">
                                    ...
                                    <input type="text" @error('ma_pet') is-invalid @enderror class="form-control"
                                        id="ma_pet" value="{{ $pet->ma_pet }}" name="ma_pet" placeholder="Mã pet">
                                    @error('ma_pet')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" @error('ten_pet') is-invalid @enderror class="form-control"
                                        id="ten_pet" value="{{ $pet->ten_pet }}" name="ten_pet" placeholder="Tên pet">
                                    @error('ten_pet')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <select name="danh_muc_id" @error('danh_muc_id') is-invalid @enderror
                                        ...
                                        @foreach ($danhMucs as $item)
                                            <option value="{{ $item->id }}"
                                                {{  $pet->danh_muc_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->ten_danh_muc }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" @error('so_luong') is-invalid @enderror class="form-control"
                                        min="1" value="{{ $pet->so_luong }}" id="so_luong" name="so_luong"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" @error('gia_pet') is-invalid @enderror
                                        class="form-control" id="gia_pet" value="{{ $pet->gia_pet }}" name="gia_pet"
                                        placeholder="Giá gốc">
                                    @error('gia_pet')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" @error('gia_khuyen_mai') is-invalid @enderror
                                        class="form-control" value="{{ $pet->gia_khuyen_mai }}" id="gia_khuyen_mai"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" @error('ngay_nhap') is-invalid @enderror class="form-control"
                                        id="ngay_nhap" value="{{ $pet->ngay_nhap }}" name="ngay_nhap"
                                        placeholder="Mã pet">
                                    @error('ngay_nhap')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea @error('mota') is-invalid @enderror class="form-control" name="mota" id="mota" cols="30"
                                        rows="3" placeholder="Mô tả ngắn">{{ $pet->mota }}</textarea>
                                    @error('mota')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="col-sm-10 mb-3 d-flex gap-2">
                                        <div class="form-check mr-3">
                                            <input type="radio" class="form-check-input" id="trang_thai"
                                                value="1" name="trang_thai"  {{  $pet->trang_thai == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" id="trang_thai"
                                                value="0" name="trang_thai"  {{  $pet->trang_thai == 0 ? 'checked' : '' }}>
                                            <label for="trang_thai" class="form-check-lable">
                                                Ẩn
                                            </label>
                                        </div>
                                ...
                                <div class="mb-3 ps-3 d-flex justify-content-between">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input bg-primary" name="is_new"
                                            id="is_new"  {{  $pet->is_new == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input bg-danger" name="is_hot"
                                            id="is_hot"  {{  $pet->is_hot == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input bg-success" name="is_home"
                                            id="is_home"  {{  $pet->is_home == 1 ? 'checked' : '' }}>
                            ...
                            <div class="col-lg-7">
                               <div class="mb-3">
                                ...
                                <textarea @error('mo_ta_chi_tiet') is-invalid @enderror id="mo_ta_chi_tiet" name="mo_ta_chi_tiet"
                                    class="form-control" cols="30" placeholder="Mô tả chi tiết" rows="5">{{ $pet->mo_ta_chi_tiet }}</textarea>
                               ...
                               <div class="mb-3">
                                ...
                                <div class="text-center mt-3">
                                    <img id="img" src="{{ Storage::url($pet->image) }}" alt="Hình ảnh" class="img-thumbnail"
                                        style="width:150px;">
                                </div>
                                </div>
                                <div class="mb-3">
...
@section('js')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var rowCount = {{ count($pet->hinhAnhPet) }};
