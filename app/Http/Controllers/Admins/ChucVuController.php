...
class ChucVuController extends Controller
{
    ...
    public function store(Request $request)
    {
        if($request->isMethod('POST')){
            ...
            return redirect()->route('chuc_vus.index')->with('success','Thêm mới thành công!');
        }
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('chuc_vus.index')->with('success','Sửa chức vụ thành công!');
    }
    ...
    public function destroy(string $id)
    {
        ...
        $list->delete();
        return redirect()->route('chuc_vus.index')->with('success','Xóa thành công!');
    }
}
