...
class HinhAnhPetController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.anh-pet.index')->with('success', 'Thêm mới thành công!');
    }
    ...
    public function edit(string $id, Pet $pets)
    {
        ...
        $petName = $pets->getPet();
        if (!$anhPet) {
            return redirect()->route('admin.anh-pet.index')->with('errors', 'Hình ảnh pet này không tồn tại!');
        }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.anh-pet.index')->with('success', 'Sửa thành công!');
    }
    ...
    public function destroy(string $id)
    {
        ...
        $anhPet->delete();
        return redirect()->route('admin.anh-pet.index')->with('success', 'Xóa thành công!');
    }
}
